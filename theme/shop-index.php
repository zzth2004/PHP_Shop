...
<body class="ecommerce">
            ...
            <div class="row ">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="shop-wishlist.php">My Cart||<i class="fa fa-shopping-cart"></i></a></li>
    ...
    <div class="header">
        <div class="container">
            <a class="site-logo" href="shop-index.php">
                <h1>PHP Shop</h1>
            </a>
                                ...
                                <div class="header-navigation-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 nav-brands">
                                            <ul>
                                                <li><a href="shop-product-list.php"><img title="esprit" alt="esprit"
                                                            src="assets/pages/img/brands/esprit.jpg"></a></li>
                                                <li><a href="shop-product-list.php"><img title="gap" alt="gap"
                                                            src="assets/pages/img/brands/gap.jpg"></a></li>
                                                <li><a href="shop-product-list.php"><img title="next" alt="next"
                                                            src="assets/pages/img/brands/next.jpg"></a></li>
                                                <li><a href="shop-product-list.php"><img title="puma" alt="puma"
                                                            src="assets/pages/img/brands/puma.jpg"></a></li>
                                                <li><a href="shop-product-list.php"><img title="zara" alt="zara"
            ...
            <div class="row margin-bottom-40 ">
                ...
                <div class="sidebar col-md-3 col-sm-4">
                    <ul class="list-group margin-bottom-25 sidebar-menu">
                        <li class="list-group-item clearfix"><a href="shop-product-list.php"><i
                                ...
                                <li class="list-group-item dropdown clearfix">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="list-group-item dropdown clearfix">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="shop-product-list.php"><i class="fa fa-angle-right"></i>
                                                        Classic 1</a></li>
                                                <li><a href="shop-product-list.php"><i class="fa fa-angle-right"></i>
                                                        Classic 2</a></li>
                                            </ul>
