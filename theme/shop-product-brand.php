...
if (isset($_GET['brand']) || $_GET['brand'] != NULL) {
    ...
    $productShowCateName = $product->productListshowCateName($brandName);
    if ($productShowCateName) {
        while ($resultCate = $productShowCateName->fetch_assoc()) {
            $cateName = $resultCate['cateName'];
        }
    }
}
            ...
            <div class="col-md-9 col-sm-7">
                ...
                <div class="row list-view-sorting clearfix">
                    <div class="col-md-2 col-sm-2">
                        ...
                        <h2 style="font-size: 25px; font-weight: 600;"><?php echo $brandName; ?></h2>
                    </div>
                ...
                <div class="row product-list">
                    ...
                    <?php
                    if (isset($_GET['brand']) || $_GET['brand'] != NULL) {
                        $productListFollowBrand = $product->productListFollowBrand($brandName);
                        if ($productListFollowBrand) {
                            while ($resultFollowBrand = $productListFollowBrand->fetch_assoc()) {
                    ?>
                                <div class="col-md-3 col-sm-4 col-xs-6">
                                    <div class="product-item" style="width: 195px; height: 253px;">
                                        <div class="pi-img-wrapper">
                                            <img src="./admin/uploads/<?php echo $resultFollowBrand['Img']; ?>" width="150" class="img-responsive" alt="Berry Lace Dress">
                                            <div>
                                                <a href="./admin/uploads/<?php echo $resultFollowBrand['Img']; ?>" class="btn btn-default fancybox-button">Zoom</a>
                                                <a href="#<?php echo $resultFollowBrand['ProductID']; ?>" class="btn btn-default fancybox-fast-view">View</a>
                                            </div>
                                        </div>
                                        <h3><a href="shop-item-details.php?productID=<?php echo $resultFollowBrand['ProductID']; ?>"><?php echo $resultFollowBrand['productName']; ?></a>
                                        </h3>
                                        <div class="pi-price">$<?php echo $resultFollowBrand['Price']; ?></div>
                                        <form action="" method="post">
                                            <input type="hidden" name="productID" value="<?php echo $resultFollowBrand['ProductID']; ?>">
                                    ...
                                    <div id="<?php echo $resultFollowBrand['ProductID']; ?>" style="display: none; width: 700px;">
                                        <div class="product-page product-pop-up">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-3">
                                                    <div class="product-main-image">
                                                        <img src="admin/uploads/<?php echo $resultFollowBrand['Img']; ?>" class="img-responsive" alt="<?php echo $resultFollowBrand['productName']; ?>" class="img-responsive">
                                                    </div>
                                                    <div class="product-other-images" style="display: flex;">
                                                        <a href="admin/uploads/<?php echo $resultFollowBrand['Img'];  ?>" class="fancybox-button" rel="photos-lib"><img alt="dell16" width="100" src="admin/uploads/<?php echo $resultFollowBrand['Img'];  ?>"></a>
                                                        <a href="admin/uploads/<?php echo $resultFollowBrand['Img'];  ?>" class="fancybox-button" rel="photos-lib"><img alt="dell16" width="100" src="admin/uploads/<?php echo $resultFollowBrand['Img'];  ?>"></a>
                                                        <a href="admin/uploads/<?php echo $resultFollowBrand['Img'];  ?>" class="fancybox-button" rel="photos-lib"><img alt="dell16" width="100" src="admin/uploads/<?php echo $resultFollowBrand['Img'];  ?>"></a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-9">
                                                    <h2><?php echo $resultFollowBrand['productName']; ?></h2>
                                                    <div class="price-availability-block clearfix">
                                                        <div class="price">
                                                            <strong><span>$</span><?php echo $resultFollowBrand['Price']; ?></strong>
                                                            <em>$<span><?php echo $resultFollowBrand['Price']; ?></span></span></em>
                                                        </div>
                                                        <div class="Status">
                                                            Status: <strong><?php
                                                                            if ($resultFollowBrand['Status'] == 0) {
                                                                                echo 'New seal';
                                                                            } else {
                                                                                echo 'Old 99%';
                                                                            }
                                                    ...
                                                    <div class="description">
                                                        <p style="font-size: 16px;"><span><i class="fa-solid fa-info"></i></span>
                                                            <?php echo $resultFollowBrand['Decription']; ?>
                                                        </p>
                                                    </div>
                                                    <div class="product-page-options">
                                                        <div class="pull-left">
                                                            <label class="control-label">Config:
                                                                <span style="font-size: 15px; color: brown;align-items: center;"><?php echo $resultFollowBrand['Config']; ?></span></label>

                                                        </div>
                                                        <div class="pull-left">
                                                            <label class="control-label">Color:
                                                                <span style="font-size: 15px; color: brown; align-items: center;"><?php echo $resultFollowBrand['Color']; ?></span></label>
                                                    ...
                                                    <div class="product-page-cart">
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="product-quantity">
                                                                <input id="product-quantity" type="number" value="1" readonly name="quanlity" min="1" max="<?php echo $resultFollowBrand['Quanlity'] ?>">
                                                            </div>
                                                            <button class="btn btn-primary" type="submit" name="submit-cart">Add to
                                                                cart</button>
                                                            <a href="shop-item-details.php?productID=<?php echo $resultFollowBrand['ProductID'] ?>" class="btn btn-default">More details</a>
                                                        </form>
                                                    </div>
                                                </div>
                        ...
                        $getproductNew = $product->showAllProduct();
                        if ($getproductNew) {
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-9">
                                                    ...
                                                    <div class="product-page-cart">
                                                        <form action="" method="post">
                                                            <input type="hidden" name="productID" value="<?php echo $resultNew['ProductID'] ?>">
                                                            <div class="product-quantity">
                                                                <input id="product-quantity" type="number" value="1" readonly name="quanlity" min="1" max="<?php echo $resultNew['Quanlity'] ?>">
                                                            </div>
                                                            <button class="btn btn-primary" type="submit" name="submit-cart">Add to
                                                                cart</button>
