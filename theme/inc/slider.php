    ...
    <div id="carousel-example-generic" class="carousel slide carousel-slider">
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="container">
                    <div class="carousel-position-four text-center">
                        <h2 class="margin-bottom-20 animate-delay carousel-title-v3 border-bottom-title text-uppercase"
                            data-animation="animated fadeInDown"></h2>
            ...
            <div class="item carousel-item-five">
                <div class="container">
                    <div class="carousel-position-four text-center">
                        <h2 class="animate-delay carousel-title-v4" data-animation="animated fadeInDown"></h2>
                        <p class="carousel-subtitle-v2" data-animation="animated fadeInDown"></p>
                        <p class="carousel-subtitle-v3 margin-bottom-30" data-animation="animated fadeInUp"></p>
                        <a class="carousel-btn" href="#" data-animation="animated fadeInUp"></a>
                    </div>
            ...
            <div class="item carousel-item-six">
                <div class="container">
                    <div class="carousel-position-four text-center">
                        ...
                        <p class="carousel-subtitle-v4" data-animation="animated fadeInDown"></p>
                        <p class="carousel-subtitle-v3" data-animation="animated fadeInDown"></p>
                    </div>
                </div>
            </div>
